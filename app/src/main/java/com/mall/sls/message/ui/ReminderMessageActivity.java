...
import com.mall.sls.message.adapter.ReminderMessageAdapter;
 ...
 * 描述：
 */
public class ReminderMessageActivity extends BaseActivity implements MessageContract.MsgInfoView, ReminderMessageAdapter.OnItemClickListener {
    ...
    public static void start(Context context, String typeId) {
        Intent intent = new Intent(context, ReminderMessageActivity.class);
    ...
    public void renderMsgInfo(MessageInfo messageInfo) {
        ...
        if (messageInfo != null) {
            if (messageInfo != null && messageInfo.getMessageItemInfos().size() > 0) {
                ...
                reminderMessageAdapter.setData(messageInfo.getMessageItemInfos());
            } else {
    ...
    public void renderMoreMsgInfo(MessageInfo messageInfo) {
        ...
        if (messageInfo != null && messageInfo.getMessageItemInfos() != null) {
            ...
            reminderMessageAdapter.addMore(messageInfo.getMessageItemInfos());
        }
    }
