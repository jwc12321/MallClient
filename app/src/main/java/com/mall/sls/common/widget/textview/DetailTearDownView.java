...
public class DetailTearDownView extends LinearLayout {
    ...
    public DetailTearDownView(Context context, AttributeSet attributeSet) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        inflater.inflate(R.layout.detail_tear_down_layout, this);
    ...
    public static class TearDownHandler extends Handler {
        private WeakReference<DetailTearDownView> mTextViewRef;

        public TearDownHandler(DetailTearDownView view) {
            mTextViewRef = new WeakReference<DetailTearDownView>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            DetailTearDownView textView = mTextViewRef.get();
            if (null != textView) {
