...
public class TwelveTearDownView extends LinearLayout {
    ...
    public TwelveTearDownView(Context context) {
        super(context);
        init(context, null);

    }

    public TwelveTearDownView(Context context, AttributeSet attributeSet) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        inflater.inflate(R.layout.layout_twelve_tear_down, this);
    ...
    public static class TearDownHandler extends Handler {
        private WeakReference<TwelveTearDownView> mTextViewRef;

        public TearDownHandler(TwelveTearDownView view) {
            mTextViewRef = new WeakReference<TwelveTearDownView>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            TwelveTearDownView textView = mTextViewRef.get();
            if (null != textView) {
