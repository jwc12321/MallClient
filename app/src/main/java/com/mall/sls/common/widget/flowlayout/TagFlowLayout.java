package com.mall.sls.common.widget.flowlayout;
 ...
 */
public class TagFlowLayout extends FlowLayoutView implements TagAdapter.OnDataChangedListener {
    ...
    public interface OnTagClickListener {
        boolean onTagClick(View view, int position, FlowLayoutView parent);
    }
