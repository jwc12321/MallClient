...
public class WhiteDMSTearDownView extends LinearLayout {
    ...
    public WhiteDMSTearDownView(Context context) {
        super(context);
        init(context, null);

    }

    public WhiteDMSTearDownView(Context context, AttributeSet attributeSet) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        inflater.inflate(R.layout.layout_white_dms_tear_down, this);
    ...
    public static class TearDownHandler extends Handler {
        private WeakReference<WhiteDMSTearDownView> mTextViewRef;

        public TearDownHandler(WhiteDMSTearDownView view) {
            mTextViewRef = new WeakReference<WhiteDMSTearDownView>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            WhiteDMSTearDownView textView = mTextViewRef.get();
            if (null != textView) {
