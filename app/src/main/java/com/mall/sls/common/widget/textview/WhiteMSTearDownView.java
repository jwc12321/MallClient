...
public class WhiteMSTearDownView extends LinearLayout {
    ...
    public WhiteMSTearDownView(Context context) {
        super(context);
        init(context, null);

    }

    public WhiteMSTearDownView(Context context, AttributeSet attributeSet) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        inflater.inflate(R.layout.layout_white_ms_tear_down, this);
    ...
    public static class TearDownHandler extends Handler {
        private WeakReference<WhiteMSTearDownView> mTextViewRef;

        public TearDownHandler(WhiteMSTearDownView view) {
            mTextViewRef = new WeakReference<WhiteMSTearDownView>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            WhiteMSTearDownView textView = mTextViewRef.get();
            if (null != textView) {
