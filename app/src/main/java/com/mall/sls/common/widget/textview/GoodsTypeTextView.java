...
public class GoodsTypeTextView extends TextView {

    public static int TAGS_INDEX_AT_START = 0;
    public static int TAGS_INDEX_AT_END = 1;

    private int tagsBackgroundStyle = R.drawable.activity_team_bg;
    ...
    public GoodsTypeTextView(Context context) {
        super(context);
        mContext = context;
    ...
    public GoodsTypeTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        Typeface typeFace1 = Typeface.createFromAsset(MainApplication.getContext().getAssets(), "fonts/Roboto-Regular-14.ttf");
        setTypeface(typeFace1);
    ...
    public GoodsTypeTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
